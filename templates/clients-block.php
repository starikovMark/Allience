    ...
    <div class="clients-content">
      ...
      <div class="clients-logo-wrapper">
        <a href="#" class="clients-logo-item">
          <picture class="clients-logo-image">
            <source type="image/webp" srcset="img/png/burger-king.webp">
            <source type="image/jpeg" srcset="img/png/burger-king.png">
            <img src="img/png/burger-king.png" alt="png: burger-king" class="clients-logo-image" />
          </picture>
        </a>
        <a href="#" class="clients-logo-item">
          <picture class="clients-logo-image">
